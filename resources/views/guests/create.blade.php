                                        ...
                                        <div class="container">
                                            <div class="carousel-item active position-relative bottom-50">
                                                <div class="container">
                                                    ...
                                                    <div class="card-header">
                                                        <h5 class="mb-0">Datos de domicilio</h5>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="adults" class="form-control"
                                                                min=1 placeholder="Adultos..." value="1">
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="kids" class="form-control"
                                                                min=0 placeholder="Niños..." value="0">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                            ...
                                            <div class="container">
                                                <a class="carousel-control-prev pb-3 mb-1" data-bs-target="#carouselExampleControls"
                                                    role="button"  data-bs-slide="prev">
                                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                    <span
                                                        class="btn btn-danger position-relative bottom-50 top-50 mt-1">Anterior</span>
                                                </a>
                                                <a class="carousel-control-next pb-3 mb-1" data-bs-target="#carouselExampleControls"
                                                    role="button" data-bs-slide="next">
                                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                                    <span
                                                        class="btn btn-danger position-relative bottom-50 top-50 mt-1">Siguiente</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
